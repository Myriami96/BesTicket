...
@WebServlet("/ServLocalita")
public class ServLocalita extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try 
		{
			array = cModel.doRetrieveByCitta(localita);
			request.setAttribute("array", array);
			RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/localita.jsp");
