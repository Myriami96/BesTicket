...
CREATE TABLE `acquista` (
  ...
  `Carrello` tinyint(4) DEFAULT '0',
  PRIMARY KEY (`Biglietto`,`Utente`),
  KEY `acquista_ibfk_2` (`Utente`),
  CONSTRAINT `acquista_ibfk_1` FOREIGN KEY (`Biglietto`) REFERENCES `biglietto` (`Cod_Biglietto`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `acquista_ibfk_2` FOREIGN KEY (`Utente`) REFERENCES `utente` (`Username`) ON DELETE CASCADE ON UPDATE CASCADE
